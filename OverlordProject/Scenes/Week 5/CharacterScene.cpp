...
void CharacterScene::Initialize()
{
	...
	const auto pLevelMesh = pLevelObject->AddComponent(new ModelComponent(L"Models/SimpleLevel.ovm"));
	pLevelMesh->SetMaterial(MaterialManager::Get()->CreateMaterial<ColorMaterial>());

	const auto pLevelActor = pLevelObject->AddComponent(new RigidBodyComponent(true));
	const auto pPxTriangleMesh = ContentManager::Load<PxTriangleMesh>(L"Models/SimpleLevel.ovpt");
